...
class TodayTask {
  ...
  TodayTask({
    ...
    assert(type == TodayTaskType.guided ? guidedTask != null : true, "GuidedTask must be provided for type TodayTaskType.guided");
    assert(type == TodayTaskType.custom ? customTask != null : true, "CustomTask must be provided for type TodayTaskType.custom");
